...
public class ProductInfoPage {
	...
	public Map<String, String> getProductDetailsMap() {
		// productMap = new HashMap<String, String>();  //UnOrdered
		//productMap = new LinkedHashMap<String, String>(); //InsertionOrdered
		productMap = new TreeMap<String, String>(); //SortedOrder
