...
public class ElementUtil {
	...
	// wait for title:
	public String waitFotTitleContains(String fractionTitle, int timeOut) throws TimeoutException {
		WebDriverWait wait = new WebDriverWait(driver, Duration.ofSeconds(timeOut));
	...
	public String waitFotTitleIs(String title, int timeOut) throws TimeoutException {
		WebDriverWait wait = new WebDriverWait(driver, Duration.ofSeconds(timeOut));
	...
	// wait for url:
	public String waitForURLContains(String fractionURL, int timeOut) throws TimeoutException {
		WebDriverWait wait = new WebDriverWait(driver, Duration.ofSeconds(timeOut));
	...
	public String waitForURLIs(String url, int timeOut) throws TimeoutException {
		WebDriverWait wait = new WebDriverWait(driver, Duration.ofSeconds(timeOut));
